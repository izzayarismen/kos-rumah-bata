<html lang="en">
    <head>
        ...
        <title>Kos Rumah Bata | Hunian Nyaman, Booking Online</title>
        <meta name="description" content="Kos modern di Yogyakarta. Eksplorasi kamar, ajukan sewa, dan bayar online dengan praktis di Kos Rumah Bata.">
        <meta name="author" content="Kos Rumah Bata">
        <meta property="og:type" content="website">
        <meta property="og:image" content="https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8f390cde-5442-4c0d-8e4b-fc586225a26a/id-preview-a7989412--45c22224-f22a-4cc1-bc02-8755a37c494b.lovable.app-1776683663255.png">
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:image" content="https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8f390cde-5442-4c0d-8e4b-fc586225a26a/id-preview-a7989412--45c22224-f22a-4cc1-bc02-8755a37c494b.lovable.app-1776683663255.png">
        <meta property="og:title" content="Kos Rumah Bata — Hunian Nyaman, Booking Online">
        <meta name="twitter:title" content="Kos Rumah Bata — Hunian Nyaman, Booking Online">
        <meta property="og:description" content="Kos modern di Yogyakarta. Eksplorasi kamar, ajukan sewa, dan bayar online dengan praktis di Kos Rumah Bata.">
        <meta name="twitter:description" content="Kos modern di Yogyakarta. Eksplorasi kamar, ajukan sewa, dan bayar online dengan praktis di Kos Rumah Bata.">
        {{-- <script type="module" crossorigin="" src="https://kos-kita-app.vercel.app/assets/index-CbfNDIxk.js"></script> --}}
        <link rel="stylesheet" crossorigin="" href="https://kos-kita-app.vercel.app/assets/index-wpPE9mTK.css">
    ...
    <body>
        <div id="root">
            <div class="min-h-screen flex flex-col bg-background">
                ...
                {{-- Footer --}}
                <footer class="border-t border-border/60 bg-secondary/40 mt-20">
                    <div class="container-app py-12 grid gap-10 md:grid-cols-4">
                        <div class="md:col-span-2">
                            <div class="flex items-center gap-2.5 mb-3">
                                <span class="grid h-9 w-9 place-items-center rounded-lg bg-gradient-primary text-primary-foreground">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house h-4.5 w-4.5">
                                    <path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"></path>
                                    <path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                </svg>
                                </span>
                                <p class="font-bold">Kos Rumah Bata</p>
                            </div>
                            <p class="text-sm text-muted-foreground max-w-md">Kos modern dengan pengalaman penyewaan digital — dari eksplorasi kamar hingga pembayaran online, semua transparan dan praktis.</p>
                        </div>
                        <div>
                            <h4 class="text-sm font-semibold mb-3">Kontak</h4>
                            <ul class="space-y-2 text-sm text-muted-foreground">
                                <li class="flex items-start gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin h-4 w-4 mt-0.5 text-primary">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone h-4 w-4 text-primary">
                                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                                </svg>
                                +62 812-3456-7890
                                </li>
                                <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail h-4 w-4 text-primary">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold mb-3">Tautan</h4>
                            <ul class="space-y-2 text-sm text-muted-foreground">
                                <li><a href="/" class="hover:text-primary">Beranda</a></li>
                                <li><a href="/kamar" class="hover:text-primary">Daftar Kamar</a></li>
                            </ul>
                        </div>
                    </div>
