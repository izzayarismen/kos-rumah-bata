    ...
    <div class="max-w-4xl mx-auto">
        <div dir="ltr" data-orientation="horizontal" class="mt-6">
            <div role="tablist" aria-orientation="horizontal" class="items-center justify-between rounded-md bg-muted text-muted-foreground w-full sm:w-auto grid grid-cols-2 sm:flex sm:flex-row gap-1 h-auto p-1" tabindex="0" data-orientation="horizontal" style="outline: none;">
                ...
                <a href="/profile/laporan-fasilitas"><button type="button" role="tab" aria-selected="true" aria-controls="radix-:r25:-content-reports" data-state="active" id="radix-:r25:-trigger-reports" class="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 gap-1.5" tabindex="-1" data-orientation="horizontal" data-radix-collection-item="">
                    ...
                    <div class="space-y-3">
                        <div class="bg-card border border-border/60 rounded-xl p-4 shadow-soft">
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    <p class="font-medium">Kamar A3</p>
                                    <p class="text-sm text-muted-foreground mt-1">QAZXSWEDCVFRTGBNHYUJMKIOLOP</p>
                                    <p class="text-xs text-muted-foreground mt-2">26 April 2026 · 📎 Screenshot_45.png</p>
                                </div>
                        ...
                        <div class="bg-card border border-border/60 rounded-xl p-4 shadow-soft">
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    <p class="font-medium">Kamar A2</p>
                                    <p class="text-sm text-muted-foreground mt-1">QWERTYUIOPLKJHGFDSAZXCVBNM</p>
                                    <p class="text-xs text-muted-foreground mt-2">26 April 2026</p>
                                </div>
                                <div class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border bg-secondary text-foreground border-border">Dikirim</div>
                            </div>
                        </div>
