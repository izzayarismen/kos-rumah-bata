    ...
    <div class="tenant-detail-grid">
        ...
        <div class="tenant-detail-card tenant-detail-profile-card">
            <div class="tenant-detail-profile-head">
                <div class="tenant-detail-avatar">NP</div>
                <h2>Nadya Putri</h2>
            ...
            <div class="tenant-detail-card">
                ...
                <div class="tenant-detail-info-grid">
                    ...
                    <div class="tenant-detail-info-box">
                        ...
                        <strong>0813-2222-1111</strong>
                    </div>

                    <div class="tenant-detail-info-box">
                        <span>Kamar</span>
                        <strong>Kamar 01 · Tower Ganjil</strong>
                    </div>
            ...
            <div class="tenant-detail-card">
                ...
                <div class="tenant-detail-payment-grid">
                    <div class="tenant-detail-payment-box">
                        ...
                        <strong>Rp 8.400.000</strong>
                    </div>

                    <div class="tenant-detail-payment-box">
                        <span>Sudah Dibayar</span>
                        <strong class="success">Rp 8.400.000</strong>
                    </div>
            ...
            <div class="tenant-detail-card">
                ...
                <div class="tenant-detail-doc-grid">
                    <div class="tenant-detail-doc-card">
                        <h4>Foto KTP</h4>
                        <div class="tenant-detail-doc-preview">Preview Foto KTP</div>
                        <div class="tenant-detail-doc-meta">File identitas penghuni untuk arsip admin.</div>
                        <a href="#" class="tenant-detail-doc-action">Lihat File</a>
                    </div>

                    <div class="tenant-detail-doc-card">
                        <h4>Surat Komitmen</h4>
                        <div class="tenant-detail-doc-preview">Preview Surat</div>
                    ...
                    <div class="tenant-detail-doc-card">
                        <h4>Catatan Admin</h4>
                        <div class="tenant-detail-doc-preview">Tidak ada catatan khusus</div>
                        <div class="tenant-detail-doc-meta">Catatan tambahan dapat dipakai untuk kebutuhan internal.</div>
                        <a href="#" class="tenant-detail-doc-action secondary">Edit Catatan</a>
                    </div>
                </div>
            </div>

            <div class="tenant-detail-actions">
                <a href="/admin/penghuni/edit" class="tenant-detail-action-btn tenant-detail-action-edit">Edit Data</a>
