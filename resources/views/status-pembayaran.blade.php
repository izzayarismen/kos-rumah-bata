                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-card border border-border/60 rounded-2xl p-5 shadow-card">
                        <div class="flex flex-wrap items-start justify-between gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <div class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border bg-warning/15 text-warning-foreground border-warning/40">Pending</div>
                    ...
                    <div class="bg-card border border-border/60 rounded-2xl p-5 shadow-card">
                        <div class="flex flex-wrap items-start justify-between gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <div class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold border" style="background-color: rgba(16, 185, 129, 0.15); color: rgb(4, 120, 87); border-color: rgba(16, 185, 129, 0.3);">Berhasil</div>
                                <div class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold border" style="background-color: rgba(16, 185, 129, 0.15); color: rgb(4, 120, 87); border-color: rgba(16, 185, 129, 0.3);">DP Terverifikasi</div>
                            </div>
                        </div>
                        <div class="mt-4 grid sm:grid-cols-3 gap-3 text-sm">
                            <div class="rounded-lg bg-secondary p-3">
